...
(define (intersection-set set1 set2)
  (list->tree (intersection-list-set (tree->list set1) (tree->list set2))))

(define (union-set set1 set2)
  (list->tree (union-list-set (tree->list set1) (tree->list set2))))
  ...
  (cond
    ...
    [else
     (let ([x1 (car set1)]
           [x2 (car set2)])
       (cond
         [(= x1 x2) (cons x1 (union-list-set (cdr set1) (cdr set2)))]
